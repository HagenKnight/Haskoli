...
using Haskoli.Infrastructure.Identity.Services;
    ...
    public static class IdentityServiceRegistration
    {
        public static IServiceCollection ConfigureIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            switch (dbSelector)
            {
                ...
                case "mssql":
                default:
                    services.AddDbContext<HaskoliIdentityDbContext>(
                       options => options.UseSqlServer(connectionString, b => b.MigrationsAssembly(typeof(HaskoliIdentityDbContext).Assembly.FullName))
                   );
                    break;
            }
            ...
            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<HaskoliIdentityDbContext>().AddDefaultTokenProviders();
